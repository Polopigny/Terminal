...
class VagueManager:
    ...
    def handle_start_delay(self):
        ...
        if time_game.time_game_seconds  == self.start_delay_duration:
            self.can_spawn = True
            self.start_delay_over = True
            self.last_wave_time = time_game.time_game_seconds
    ...
    def update_wave_state(self):
        ...
        if self.start_delay_over:
            if self.is_wave_ready:
                self.last_wave_time = time_game.time_game_seconds
                self.is_wave_ready = False
            elif time_game.time_game_seconds >= self.last_wave_time + self.wave_interval:
    ...
    def update_wave_timer_draw(self):
        ...
        """
        self.remaining_time_until_wave = self.last_wave_time + self.wave_interval - time_game.time_game_seconds
